...
########################################
### sampling and eval
CUDA_VISIBLE_DEVICES=2 python validate_pickascore.py sample --pretrained-model-name runwayml/stable-diffusion-v1-5 --out-dir outputs/pickascore/mcdpo_all_4000beta_fixlabel_20norm_mlp_ipadapter_simple_cfg4 --ipadapter-ckpt tmp-sd15-all-scores-cdpo-500steps-4000beta-fixlabel-20norm-mlp-ipadapter-sfttrained-simultaneous-simple-multidim/checkpoint-500 --prompts-file data/pickascore/prompts.txt --seed 0 --guidance-scale 4 --guidance-rescale 0.7 --cond-positive-text "win win win win win" --cond-negative-text "lose lose lose lose lose" --cond-projector-type "mlp" --cond-mlp-hidden-dim 4096 && CUDA_VISIBLE_DEVICES=2 python validate_pickascore.py eval-folders --prompts outputs/pickascore/baseline/prompts.jsonl --baseline-folder outputs/pickascore/baseline/baseline --dpo-folder outputs/pickascore/mcdpo_all_4000beta_fixlabel_20norm_mlp_ipadapter_simple_cfg4/dpo